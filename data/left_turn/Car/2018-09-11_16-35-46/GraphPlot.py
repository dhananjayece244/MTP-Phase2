...
def Gyroscope():
    ...
    pltg.xticks(np.arange(5000,120000,5000))
    pltg.grid()
    ...
    pltg.plot(listMG,listXG, linewidth=2.0)
    # pltg.legend()
    # pltg.savefig('Graph/GyroXt.png', dpi = 300)
    # pltg.legend()
    pltg.plot(listMG,listYG, linewidth=2.0)
    # pltg.savefig('Graph/GyroXYt.png', dpi = 300)
    pltg.plot(listMG,listZG, linewidth=2.0)
    pltg.legend()
...
def Accelerometer():
    ...
    plt.xticks(np.arange(5000,120000,5000))
    plt.grid()
    fig.suptitle('Accelerometer', fontdict=font)
    plt.xlabel('Time(ms)', fontdict=font)
    ...
    plt.plot(listM,listY, linewidth=2.0)
    # plt.legend()
    # plt.savefig('Graph/AccXYt.png', dpi = 300)

    plt.plot(listM,listZ, linewidth=2.0)
    plt.legend()
...
def AccelerometerLinear():
    ...
    pltal.xticks(np.arange(5000,120000,5000))
    pltal.grid()
    ...
    pltal.plot(listML,listXL, linewidth=2.0)
    # pltal.legend()
    # pltal.savefig('Graph/AccLXt.png', dpi = 300)


    pltal.plot(listML,listYL, linewidth=2.0)
    # pltal.legend()
    # pltal.savefig('Graph/AccLXYt.png', dpi = 300)


    pltal.plot(listML,listZL, linewidth=2.0)
    pltal.legend()
...
def Compass():
    ...
    pltc.xticks(np.arange(5000,120000,5000))
    pltc.grid()
    ...
    pltc.plot(listMC,listXC, linewidth=2.0)
    # pltc.legend()
    # pltc.savefig('Graph/CompXt.png', dpi = 300)


    pltc.plot(listMC,listYC, linewidth=2.0)
    # pltc.legend()
    # pltc.savefig('Graph/CompXYt.png', dpi = 300)

    pltc.plot(listMC,listZC, linewidth=2.0)
    pltc.legend()
...
def RotationVector():
    ...
    pltrv1.xticks(np.arange(5000,120000,5000))
    pltrv1.grid()
    pltrv1.plot(listMRV,listCosRV, linewidth=2.0)
    pltrv1.legend()
    ...
    pltrv.xticks(np.arange(5000,120000,5000))
    pltrv.grid()
    ...
    pltrv.plot(listMRV,listXRV, linewidth=2.0)
    # pltrv.legend()
    # pltrv.savefig('Graph/RotVecXt.png', dpi = 300)


    pltrv.plot(listMRV,listYRV, linewidth=2.0)
    # pltrv.legend()
    # pltrv.savefig('Graph/RotVecXYt.png', dpi = 300)

    pltrv.plot(listMRV,listZRV, linewidth=2.0)
    pltrv.legend()
